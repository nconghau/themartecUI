...
const LoginFormView = (props: Props) => {
  return (
    <div className='login-header-container h-full'>
      <div className='w-full h-full flex flex-col items-start text-left py-32'>
        ...
        <div className='login-form-container'>
          ...
          <Button className='bg-blue-400 rounded-3xl w-full'>
            Create account
          </Button>
          <div className='text-xs mt-2'>By signing up, you agree to the Terms of Service and Privacy Policy, including Cookie Use.</div>
        </div>
        <div className='login-form-container'>
          <div className='text-lg font-bold'>Already have an account?</div>
          <Button variant="outline" className='flex items-center bg-transparent text-black border border-black rounded-3xl w-full mt-4'>
            <span>Sign in</span>
          </Button>
        </div>
      </div>
